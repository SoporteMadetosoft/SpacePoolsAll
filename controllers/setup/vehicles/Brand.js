const BrandDao = require('../../../dao/setup/vehicles/BrandDao')
const Brand = require('../../../models/setup/vehicles/VehiclesBrand')
...
exports.listByID = async (req, res) => {
    ...
    try {
        res.json({
            ok: true,
            data: await brandDao.findById(id)
        })
