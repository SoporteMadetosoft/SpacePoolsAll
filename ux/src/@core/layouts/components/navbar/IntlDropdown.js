  ...
  return (
    <UncontrolledDropdown href='/' tag='li' className='dropdown-language nav-item'>
      ...
      <DropdownMenu className='mt-0' right>
        <DropdownItem toggle={null} href='/' onClick={e => handleLangUpdate(e, 'en')}>
          <ReactCountryFlag className='country-flag' countryCode='us' svg />
          <span className='ml-1'>English</span>
        </DropdownItem>
        <DropdownItem toggle={null} href='/' onClick={e => handleLangUpdate(e, 'fr')}>
          <ReactCountryFlag className='country-flag' countryCode='fr' svg />
          <span className='ml-1'>French</span>
        </DropdownItem>
        <DropdownItem toggle={null} href='/' onClick={e => handleLangUpdate(e, 'de')}>
          <ReactCountryFlag className='country-flag' countryCode='de' svg />
          <span className='ml-1'>German</span>
        </DropdownItem>
        <DropdownItem toggle={null} href='/' onClick={e => handleLangUpdate(e, 'pt')}>
