...
const initialState = {
    ...
    Vehicles: { read: true, insert: true, update: true, delete: true, actions: true },
    ...
    Activity: { read: true, insert: true, update: true, delete: true },
    Origin: { read: true, insert: true, update: true, delete: true },
