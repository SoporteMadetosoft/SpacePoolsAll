...
export const VehicleRepairForm = () => {
    ...
    useEffect(() => {
        if (id === undefined) {
            dispatch(GetSetNextId("VRepair", 'idRepair'))
        }
    }, [])
    ...
    const submit = async (e) => {
        ...
        form2.then(async (value) => {
            ...
            const prettyForm = {
                ...value,
                idVehicle: value.idVehicle !== undefined ? value.idVehicle : data[index].id
            }


            save('VRepair', id, prettyForm)
