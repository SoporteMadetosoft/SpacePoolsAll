...
import { vehiclesDocs } from '../../../fixed/vehicles/vehicles/vehiclesDocs'

export const VehicleDocForm = () => {
    ...
    const uploadFileToCloud = async (e) => {
        ...
        const filePath2 = await MkDir('Vehicles', realFilePath)
    ...
    return (
        <div className="card">
            ...
            <CustomMiniTable columns={vehiclesDocs} data={data} />
        </div>
    )
}
